...
/*SF_DATA;ver:1.38;sub:START;pass:START;ps:flbk:,iptp:0,cusa:False,bamd:0,cgin:,lico:1,lgpr:1,limd:3,spmd:1,trmd:0,grmd:0,uamb:True,mssp:True,bkdf:True,hqlp:False,rprd:True,enco:False,rmgx:True,imps:True,rpth:0,vtps:0,hqsc:True,nrmq:1,nrsp:0,vomd:0,spxs:False,tesm:0,olmd:1,culm:0,bsrc:0,bdst:1,dpts:2,wrdp:True,dith:0,atcv:False,rfrpo:True,rfrpn:Refraction,coma:15,ufog:True,aust:True,igpj:False,qofs:0,qpre:1,rntp:1,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,stcl:False,atwp:False,stva:128,stmr:255,stmw:255,stcp:6,stps:0,stfa:0,stfz:0,ofsf:0,ofsu:0,f2p0:False,fnsp:False,fnfb:False,fsmp:False;n:type:ShaderForge.SFN_Final,id:2865,x:32930,y:32745,varname:node_2865,prsc:2|diff-6616-RGB,spec-9876-OUT,emission-3326-OUT;n:type:ShaderForge.SFN_Tex2d,id:7736,x:31708,y:32122,ptovrint:True,ptlb:chest head,ptin:_chest_head,varname:_chest_head,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:8212d13c320a3c6449bdb2c550eebc05,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Slider,id:358,x:31522,y:32399,ptovrint:True,ptlb:chest_head_intensity,ptin:_ch_intensity,varname:_ch_intensity,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:1,max:1;n:type:ShaderForge.SFN_Tex2d,id:2140,x:31718,y:32570,ptovrint:True,ptlb:chest tail,ptin:_chest_tail,varname:_chest_tail,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:b80b4421b0646514a862b44258f74f9b,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Tex2d,id:1800,x:31782,y:32984,ptovrint:True,ptlb:head tail,ptin:_head_tail,varname:_head_tail,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:06eee544f315e8946b9ff50b3878d712,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Add,id:3326,x:32387,y:32645,varname:node_3326,prsc:2|A-8805-OUT,B-299-OUT,C-9473-OUT;n:type:ShaderForge.SFN_Tex2d,id:6616,x:32491,y:32320,ptovrint:True,ptlb:base color,ptin:_MainTex,varname:_MainTex,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Slider,id:5632,x:31625,y:32797,ptovrint:True,ptlb:chest_tail_intensity,ptin:_ct_intensity,varname:_ct_intensity,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:1,max:1;n:type:ShaderForge.SFN_Slider,id:7667,x:31688,y:33187,ptovrint:True,ptlb:head_tail_intensity,ptin:_ht_intensity,varname:_ht_intensity,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:1,max:1;n:type:ShaderForge.SFN_Multiply,id:8805,x:32096,y:32445,varname:node_8805,prsc:2|A-7736-RGB,B-358-OUT;n:type:ShaderForge.SFN_Multiply,id:299,x:31955,y:32625,varname:node_299,prsc:2|A-2140-RGB,B-5632-OUT;n:type:ShaderForge.SFN_Multiply,id:9473,x:32200,y:32895,varname:node_9473,prsc:2|A-1800-RGB,B-7667-OUT;n:type:ShaderForge.SFN_Vector1,id:9876,x:32364,y:33154,varname:node_9876,prsc:2,v1:0;proporder:7736-358-2140-1800-6616-5632-7667;pass:END;sub:END;*/

Shader "Shader Forge/dragon" {
    Properties {
...
////// Emissive:
                ...
                float3 node_3326 = ((_chest_head_var.rgb*_ch_intensity)+(_chest_tail_var.rgb*_ct_intensity)+(_head_tail_var.rgb*_ht_intensity));
                float3 emissive = node_3326;
/// Final Color:
