...
///////// Gloss:
                float node_4495 = 0.0;
                float gloss = node_4495;
                float perceptualRoughness = 1.0 - node_4495;
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float3 specColor;
                float node_4495 = 0.0;
                diffColor = DiffuseAndSpecularFromMetallic( diffColor, node_4495, specColor, specularMonochrome );
                float roughness = 1.0 - node_4495;
